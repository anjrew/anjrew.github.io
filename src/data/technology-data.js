...
export const techData = {
    ...
    ionic: new Technology({
        smallImageUrl: '/assets/images/tech-icons/ionic/1602188363712_funvks_c_scale,w_60.jpg',
        largeImageUrl: '/assets/images/tech-icons/ionic/1602188363712_funvks_c_scale,w_60.jpg',
        name: 'Ionic',
    ...
    androidStudioLink: new Technology({ 
    ...
    parseServerLink: new Technology({ 
    ...
    googleCloudPlatform: new Technology({
    ...
    scss: new Technology({
        smallImageUrl: '/assets/images/tech-icons/scss/zb1ust8dwqd5zqbckma9_c_scale,w_60.png',
        largeImageUrl: '/assets/images/tech-icons/scss/zb1ust8dwqd5zqbckma9_c_scale,w_100.png',
        name: 'SCSS',
...
export const techLinks = Object.keys(techData).map(k => techData[k]);
